 ...
 *
 * The listed script "spiders" the documentation of the php-mysql-extension on php.net (//php.net/manual/en/book.mysql.php)
...
$crawler->setURL("//www.php.net/manual/en/book.mysql.php");
...
// "//www.php.net/manual/en/function.mysql-affected-rows.php"
// or "//www.php.net/manual/en/mysql.setup.php", they all contain
// "//www.php.net/manual/en/" followed by  "mysql" somewhere.
// So we add a corresponding follow-rule to the crawler.
$crawler->addURLFollowRule("#^//www.php.net/manual/en/.*mysql[^a-z]# i");
