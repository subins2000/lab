...
class PHPCrawlerRobotsTxtParser
{
  ...
  { 
    ...
    // Works like this:
    // The base-url is //www.foo.com.
    // The driective says: "Disallow: /bla/"
    // This means: The nonFollowMatch is "#^//www\.foo\.com/bla/#"
    ...
    for ($x=0; $x<count($disallow_pathes); $x++)
    {
      ...
      $non_follow_path_complpete = $normalized_base_url.substr($disallow_pathes[$x], 1); // "//www.foo.com/bla/"
      $non_follow_exp = preg_quote($non_follow_path_complpete, "#"); // "//www\.foo\.com/bla/"
      $non_follow_exp = "#^".$non_follow_exp."#"; // "#^//www\.foo\.com/bla/#"
