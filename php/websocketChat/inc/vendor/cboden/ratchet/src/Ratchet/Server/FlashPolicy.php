 ...
 * @final
 * @link //www.adobe.com/devnet/articles/crossdomain_policy_file_spec.html
 * @link //learn.adobe.com/wiki/download/attachments/64389123/CrossDomain_PolicyFile_Specification.pdf?version=1
 * @link view-source://www.adobe.com/xml/schemas/PolicyFileSocket.xsd
 */
class FlashPolicy implements MessageComponentInterface {
     ...
     * @var string
     */
    protected $_policy = '<?phpxml version="1.0"?><!DOCTYPE cross-domain-policy SYSTEM "//www.adobe.com/xml/dtds/cross-domain-policy.dtd"><cross-domain-policy></cross-domain-policy>';
