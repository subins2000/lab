...
class Url
{
     ...
     *                              on strict RFC 3986 section 5.4.1. This means that "//a.com/foo/baz" merged with
     *                              "bar" would become "//a.com/foo/bar". When this value is set to false, it would
     *                              become "//a.com/foo/baz/bar".
     * @return Url
     * @throws InvalidArgumentException
     * @link //tools.ietf.org/html/rfc3986#section-5.4
     */
