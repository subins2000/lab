...
<p>There is a simple, much better, more secure login system called <a href="<?php echo $GLOBALS['parr'][27]['d']; ?>">logSys</a>. I HIGHLY advice you to use that instead of this.</p>
