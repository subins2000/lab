    ...
    <?php top();?>
        <div class="container" id="content">
            <form action="index.php" method="POST">
                URL : <input name="url" size="35" value="https://subinsb.com" />
                <input type="submit" name="submit" value="Start Crawling"/>
            </form>
            <br/>
            <b>The URLs you submit for crawling are recorded.</b><br/>See All Crawled URLs <a href="url-crawled.html">here</a>.
            <?php
            ...
            if (isset($_POST['submit'])) {
                ...
                if (!isDomainAvailible($url)) {
                    ...
                    fclose($f);
                    echo "<h2>Result</h2><ul style='word-wrap: break-word;width: 400px;line-height: 25px;'>";
                    crawlSite($url);
                    echo '</ul>';
                }
            }
