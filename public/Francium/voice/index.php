...
<html>
   ...
   <body>
    ...
    <div class="container" id="content">
      <p>
        <h2>NOTE</h2>
        <p>Since Chrome version 47, Voice Recording works only on HTTPS sites. You can see the demo on HTTPS <a href="https://demos.subinsb.com/Francium/voice/">here</a>.</p>
      </p>
      <h2>Record</h2>
