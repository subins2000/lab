 ...
 * Apache License v2.0 (//apache.org/licenses/LICENSE-2.0.txt), or
 * GNU General Public License v2.0 (//gnu.org/licenses/gpl-2.0.txt).
 */
...
* - Fix a bug in Safari's parser (//forums.asp.net/thread/1585609.aspx)
...
*   (//dean.edwards.name/packer/2/usage/#triple-semi-colon).
