...
interface RequestInterface extends MessageInterface, HasDispatcherInterface
{
    ...
    /**
     * Get the full URL of the request (e.g. '//www.guzzle-project.com/')
     *
     ...
     *
     * @return self
     * @link //www.ietf.org/rfc/rfc2617.txt
     * @link //php.net/manual/en/function.curl-setopt.php See the available options for CURLOPT_HTTPAUTH
