...
[![Build Status](https://secure.travis-ci.org/cboden/Ratchet.png?branch=master)](//travis-ci.org/cboden/Ratchet)
...
* Ratchet [passes](//socketo.me/reports/ab/) the [Autobahn Testsuite](//autobahn.ws/testsuite) (non-binary messages)
...
You can find more details in the [server conf docs](//socketo.me/docs/deploy#serverconfiguration).
...
User and API documentation is available on Ratchet's website: //socketo.me
