...
class UrlGeneratorTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testAbsoluteUrlWithExtraParameters()
    {
        ...
        $this->assertEquals('//localhost/app.php/testing?foo=bar', $url);
    }
    ...
    public function testSchemeRequirementForcesAbsoluteUrl()
    {
        ...
        $routes = $this->getRoutes('test', new Route('/', array(), array('_scheme' => 'http'))); // BC
        $this->assertEquals('//localhost/app.php/', $this->getGenerator($routes, array('scheme' => 'https'))->generate('test'));
    ...
    public function testWithHostSameAsContextAndAbsolute()
    {
        ...
        $this->assertEquals('//fr.example.com/app.php/Fabien', $this->getGenerator($routes, array('host' => 'fr.example.com'))->generate('test', array('name' =>'Fabien', 'locale' => 'fr'), true));
    }
    ...
    public function testGenerateNetworkPathBC()
    {
        ...
        $this->assertSame('//fr.example.com/app.php/Fabien', $this->getGenerator($routes, array('scheme' => 'https'))->generate('test',
