...
class RequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $request = Request::create('//user_test:password_test@test.com/');
    ...
    {
        $request = Request::create('//test.com/foo?bar=baz');
        $this->assertEquals('//test.com/foo?bar=baz', $request->getUri());
        ...
        $request = Request::create('//test.com/foo', 'GET', array('bar' => 'baz'));
        $this->assertEquals('//test.com/foo?bar=baz', $request->getUri());
        $this->assertEquals('/foo', $request->getPathInfo());
        $this->assertEquals('bar=baz', $request->getQueryString());
        $this->assertEquals(80, $request->getPort());
        ...
        $request = Request::create('//test.com/foo?bar=foo', 'GET', array('bar' => 'baz'));
        $this->assertEquals('//test.com/foo?bar=baz', $request->getUri());
        $this->assertEquals('/foo', $request->getPathInfo());
        $this->assertEquals('bar=baz', $request->getQueryString());
        $this->assertEquals(80, $request->getPort());
        ...
        $this->assertEquals('//test.com:90/foo', $request->getUri());
        $this->assertEquals('/foo', $request->getPathInfo());
        ...
        $request = Request::create('//example.com/jsonrpc', 'POST', array(), array(), array(), array(), $json);
        $this->assertEquals($json, $request->getContent());
        $this->assertFalse($request->isSecure());

        $request = Request::create('//test.com');
        $this->assertEquals('//test.com/', $request->getUri());
        ...
        $request = Request::create('//test.com?test=1');
        $this->assertEquals('//test.com/?test=1', $request->getUri());
        $this->assertEquals('/', $request->getPathInfo());
        ...
        $request = Request::create('//test.com:90/?test=1');
        $this->assertEquals('//test.com:90/?test=1', $request->getUri());
        $this->assertEquals('/', $request->getPathInfo());
        $this->assertEquals('test=1', $request->getQueryString());
        $this->assertEquals(90, $request->getPort());
        $this->assertEquals('test.com:90', $request->getHttpHost());
        ...
        $request = Request::create('//test:test@test.com');
        $this->assertEquals('//test.com/', $request->getUri());
        $this->assertEquals('/', $request->getPathInfo());
        $this->assertEquals('', $request->getQueryString());
        $this->assertEquals(80, $request->getPort());
        ...
        $request = Request::create('//testnopass@test.com');
        $this->assertEquals('//test.com/', $request->getUri());
        $this->assertEquals('/', $request->getPathInfo());
        $this->assertEquals('', $request->getQueryString());
        $this->assertEquals(80, $request->getPort());
        ...
        $request = Request::create('//test.com/?foo');
    ...
    public function testCreateCheckPrecedence()
    {
        ...
        $request = Request::create('//thomas:pokemon@example.net:8080/?foo=bar', 'GET', array(), array(), array(), array(
            'HTTP_HOST'   => 'example.com',
            'HTTPS'       => 'on',
            'SERVER_PORT' => 443,
        ));
    ...
    public function testGetUri()
    {
        ...
        // //host:8080/index.php/path/info?query=string
        ...
        $this->assertEquals('//host:8080/index.php/path/info?query=string', $request->getUri(), '->getUri() with non default port');
        ...
        $this->assertEquals('//host/index.php/path/info?query=string', $request->getUri(), '->getUri() with default port');
        ...
        $this->assertEquals('//servername/index.php/path/info?query=string', $request->getUri(), '->getUri() with default port without HOST_HEADER');

        // Request with URL REWRITING (hide index.php)
        //   RewriteCond %{REQUEST_FILENAME} !-f
        //   RewriteRule ^(.*)$ index.php [QSA,L]
        // //host:8080/path/info?query=string
        $server = array();
        $server['HTTP_HOST'] = 'host:8080';
        $server['SERVER_NAME'] = 'servername';
        $server['SERVER_PORT'] = '8080';
        ...
        $request->initialize(array(), array(), array(), array(), array(), $server);
        $this->assertEquals('//host:8080/path/info?query=string', $request->getUri(), '->getUri() with rewrite');

        // Use std port number
        //  //host/path/info?query=string
        $server['HTTP_HOST'] = 'host';
        $server['SERVER_NAME'] = 'servername';
        $server['SERVER_PORT'] = '80';
        ...
        $this->assertEquals('//host/path/info?query=string', $request->getUri(), '->getUri() with rewrite and default port');
        ...
        $this->assertEquals('//servername/path/info?query=string', $request->getUri(), '->getUri() with rewrite, default port without HOST_HEADER');
        ...
        $this->assertEquals(
            '//host:8080/ba%20se/index_dev.php/foo%20bar/in+fo?query=string',
            $request->getUri()
        );
        ...
        $request->initialize(array(), array(), array(), array(), array(), $server);
        $this->assertEquals('//host:8080/ba%20se/index_dev.php/foo%20bar/in+fo?query=string', $request->getUri());
    ...
    {
        $request = Request::create('//test.com/foo?bar=baz');
        $this->assertEquals('//test.com/some/path', $request->getUriForPath('/some/path'));

        $request = Request::create('//test.com:90/foo?bar=baz');
        $this->assertEquals('//test.com:90/some/path', $request->getUriForPath('/some/path'));
        ...
        $this->assertEquals('//host:8080/index.php/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with non default port');
        ...
        $this->assertEquals('//host/index.php/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with default port');
        ...
        $this->assertEquals('//servername/index.php/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with default port without HOST_HEADER');
        ...
        $request->initialize(array(), array(), array(), array(), array(), $server);
        $this->assertEquals('//host:8080/some/path', $request->getUriForPath('/some/path'), '->getUri() with rewrite');
        ...
        $this->assertEquals('//host/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with rewrite and default port');
        ...
        $this->assertEquals('//servername/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with rewrite, default port without HOST_HEADER');
        ...
        $server['PHP_AUTH_USER'] = 'fabien';
        $request->initialize(array(), array(), array(), array(), array(), $server);
        $this->assertEquals('//servername/some/path', $request->getUriForPath('/some/path'));
    ...
    public function testGetSchemeAndHttpHost()
    {
        ...
        $request->initialize(array(), array(), array(), array(), array(), $server);
        $this->assertEquals('//servername:90', $request->getSchemeAndHttpHost());
    ...
    {
        $request = Request::create('//example.com', 'GET', array(), array(), array(), array(
