...
<html>
    ...
    <body>
        ...
        <div class="container" id="content">
            ...
            <form>
                <textarea class="materialize-textarea" id="വാക്യം" placeholder="ഇംഗ്ലീഷ് അക്കമുള്ള വാക്യം ഇവിടെ എഴുതുക... Write English numerals here..."></textarea>
            </form>
            ...
            <form>
                <textarea class="materialize-textarea" id="മലയാളവാക്യം" placeholder="ഇംഗ്ലീഷ് അക്കമുള്ള വാക്യം ഇവിടെ എഴുതുക... Write English numerals here..."></textarea>
            </form>
            <textarea class="materialize-textarea" id="ഇംഗ്ലീഷിലേക്ക്മാറ്റിയവാക്യം" placeholder="മലയാള അക്കത്തിലേക്ക് മാറ്റിയ വാക്യം ഇവിടെ ദൃശ്യമാകും... Converted Malayalam numerals equivalent will be displayed here..." readonly="readonly"></textarea>
            ...
            <script type="text/thengascript">
                ...
                ആവട്ടെ മലയാളവാക്യസ്ഥലം = document.getElementById('മലയാളവാക്യം'),
                      ഇംഗ്ലീഷിലേക്ക്മാറ്റിയവാക്യസ്ഥലം = document.getElementById('ഇംഗ്ലീഷിലേക്ക്മാറ്റിയവാക്യം');
                മലയാളവാക്യസ്ഥലം.addEventListener('keyup', () => {
                    ഇംഗ്ലീഷിലേക്ക്മാറ്റിയവാക്യസ്ഥലം.value = മലയക്കം(മലയാളവാക്യസ്ഥലം.value, ശരി);
                });
            </script>
            <style>
